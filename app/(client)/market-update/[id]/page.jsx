...
export default function MarketUpdateDetails () {
  ...
  return (
    <div>
      {/* Banner */}
      <Banner bannerImg="https://pub-338f0345bf6c431fbd5bd8d3f2174595.r2.dev/banner-photos/144221.jpg" text="Market Details" Icon={BsStack} breadcrumb={`home/market-update/${id}` } />
        ...
        <div>
          <Link href="/market-update">
            <button className='inline-flex items-center gap-x-2 btn__style cursor-pointer group mb-5 '>
              <FaLongArrowAltLeft className='text-base text-green-400  group-hover:text-white' />
