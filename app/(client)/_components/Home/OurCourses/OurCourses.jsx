    ...
    <section>
      ...
      <div className=" course__container  section_topSpace">
        ...
        <div className="card__border course__card__parent">
          ...
          <div className="mt-5">
            <BaseBtn text="Join Now" icon={MdArrowOutward} link="/technical-analysis" />
          </div>
        </div>
        {/* left second card */}
        <div className="card__border course__card__parent">
          ...
          <div className="mt-5">
            <BaseBtn text="Join Now" icon={MdArrowOutward} link="/derivatives-market" />
          </div>
        </div>
        ...
        <div className="card__border course__card__parent">
          ...
          <div className="mt-5">
            <BaseBtn text="Join Now" icon={MdArrowOutward} link="/funda-Module" />
          </div>
        </div>
        ...
        <div className="card__border course__card__parent">
          ...
          <div className="mt-5">
            <BaseBtn text="Join Now" icon={MdArrowOutward} link="/fundamental-analysis" />
          </div>
        </div>
        <div className="card__border course__card__parent">
          <h3 className="small__title course__card__title">
          ...
          <div className="mt-5">
            <BaseBtn text="Join Now" icon={MdArrowOutward} link="/finance-Program"/>
          </div>
        </div>
      </div>
    </section>
